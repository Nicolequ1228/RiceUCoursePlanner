...
import { queryGPT } from '@/lib/chat/gpt-request';
...
async function submitUserMessage(content: string) {
    'use server'
    const solr_request_url = await queryGPT(content);
    // console.log(solr_request_url);
    const solr_data = await querySolr(solr_request_url);
    const solr_data_string = solr_data.toString();
    // console.log(solr_data_string);
