...
async function queryGPT(content: string): Promise<any> {
    ...
    Replace <keyword> with the academic topic or potential query in user text which is in between two %22. 
    For example, "Recommend some history related courses" should replace <keyword> with %22history%22.
